  ...
  channels() 
{
  ...
  music = Mix_LoadMUS("assets/sound/othermusic.ogg");
  if (!music) throw string("Couldn't load othermusic.ogg : ")+Mix_GetError();
  startMusic();
  ...
  */
  sounds.push_back( Mix_LoadWAV("assets/sound/quack.wav") );
  sounds.push_back( Mix_LoadWAV("assets/sound/honk.wav") );
  if(sounds[0] == NULL || sounds[1] == NULL) throw string("Unable to open audio!");
